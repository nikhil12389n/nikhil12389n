...
export default function Addmonuments() {
  ...
  <div className="mb-3">
    ...
    <input type="float" className="form-control" id="rating"  name="rating" onChange={(e)=>Setvalues({...values,[e.target.name]:e.target.value})}/>
  </div>
  <div className="mb-3">
  ...
  <div className="mb-3">
    ...
    <input type="text" className="form-control" id="cost" name="cost" onChange={(e)=>Setvalues({...values,[e.target.name]:e.target.value})}/>
  </div>
  <div className="mb-3">
    <label htmlFor="slots" className="form-label">Slots</label>
    <input type="text" className="form-control" id="slots" name="slots" onChange={(e)=>Setvalues({...values,[e.target.name]:e.target.value})}/>
  </div>
  <div className="mb-3">
